...
return [
    ...
    */
    ...
    'current_pipeline_step' => 'مرحله انتخابی برای کارت صحیح نمیباشد',
    'campaign_date'         => 'زمان کمپین از تاریخ کاریز بیشتر میباشد',
    'array_or_uuid'         => 'گزینه :attribute باید یک آرایه یا UUID باشد',

    'mobile_prefix' => 'پیش شماره موبایل صحیح نمی باشد',
    'mobile' => 'موبایل صحیح نمی باشد',
    ...
    */
    ...
    'custom' => [
        ...
        'user_exists_in_other_team' => 'کاربر در تیم دیگری وجود دارد.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'target_monthly'     => 'هدف ماهانه',
        'target_semi_annual' => 'هدف نیم ساله',
        'target_yearly'      => 'هدف سالانه',

        'min_price'                 => 'حداقل قیمت',
        'max_price'                 => 'حداکثر قیمت',
        'label_uuid'                => 'شناسه برچسب',
        'addresses'                 => 'ادرس ها',
        'register_type'             => 'نوع ثبت نام',
        'addresses.*.province_uuid' => 'استان',
        'addresses.*.city_uuid'     => 'شهر',
        'addresses.*.area_uuid'     => 'منظقه',
